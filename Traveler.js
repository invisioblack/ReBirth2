...
class Traveler {
    ...
    static travelTo(creep, destination, options = {}) {
        ...
        creep.highlightStructure(Game.getObjectById(creep.memory.target));
        ...
        if (!travelData.path) {
            ...
            travelData.path = Traveler.serializePath(creep.pos, ret.path, creep.room.visual.creepPathStyle(creep));
            state.stuckCount = 0;
        }
     ...
     * @returns {string}
     */
    static serializePath(startPos, path, style) {
        let serializedPath = "";
        let lastPosition = startPos;
        this.circle(startPos, style.color);
...
Creep.prototype.travelTo = function (destination, options) {
    //console.log(destination.pos.roomName);
